...
class TransMotionDetectorV2(nn.Module):
    ...
    def __init__(
        ...
        if seperate_det_track_head:
            ...
            raw_bbox_embed.layers[-1].bias.requires_grad_(False)
            ...
            if self.as_two_stage:
                for bbox_embed_layer in self.track_bbox_embed:
                    nn.init.constant_(bbox_embed_layer.layers[-1].bias.data[2:], 0.0)
    ...
    def simple_test(
        ...
        img,
        img_metas, 
        track_embeds,           # 1 x T x E
        track_motions,          # 1 x T x 4
        track_instance_ids,     # 1 x T
    ):
        return self.forward(
            img,
            img_metas, 
    ...
    def forward(
        ...
        (
            ...
            track_embeds, track_reference_points
        )
